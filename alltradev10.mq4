...
/*定义外汇服务商FXCM的宏特性*/
	...
	#define HTIMEZONEFXCMDIFF 5
	#define HTIMEZONEDIFF HTIMEZONEFXCMDIFF
...
/*定义外汇服务商HFXPRO的宏特性*/
	...
	#define HTIMEZONEFXPRODIFF 5
	#define HTIMEZONEDIFF HTIMEZONEFXPRODIFF
...
/*定义外汇服务商HFXPRO的宏特性*/
	...
	#define HTIMEZONEMARKETSDIFF 8
	#define HTIMEZONEDIFF HTIMEZONEMARKETSDIFF
...
void monitoraccountprofit()
{
	...
	//if(1 == Period())
	{
		...
		else if ((TimeHour(timelocal) >= 20 )&& (TimeHour(timelocal) <=22 )) 
		{
			...
			/*超过4个订单，且每个订单都盈利的情况下，直接关掉所有盈利订单*/
