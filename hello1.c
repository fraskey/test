...
//	int i;
	...
	if ((TimeHour(TimeLocal()) >= 15 )&& (TimeHour(TimeLocal()) <22 )) //下午3点前不做趋势单，主要针对1分钟线，非欧美时间趋势不明显
	{
		tradetimeflag = true;		
	}	
...
//////////////////////////////////////////////////////////////////////////////
   ...
   for(SymPos = 0; SymPos < symbolNum;SymPos++)
   {
   	...
   	if (5 == Period() )
    {
      /*获取必要参数*/
		...
		//突破型买点，在欧美交易时间交投活跃期间开突破类型单，防止假突破
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/*超过30美金，直接关掉所有订单，落袋为安，完成一次循环*/
	if(orderprofitall() > 30)
	{
		ordercloseall();
