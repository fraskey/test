...
datetime feinongtime= D'2016.06.15 01:00:00';  // Year Month Day Hours Minutes Seconds
int feilongtimeoffset = 60;
...
int MakeMagic(int SymPos,int Magic)
{
   ...
   else if (MySymbol[SymPos] == "OILUSD")
   {
      symbolvalue = 21000;
   
   }   
   else if (MySymbol[SymPos] == "USDIDX")
   {
      symbolvalue = 22000;
...
//////////////////////////////////////////////////////////////////////////////
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if((OrdersTotal()==4)&&(orderprofitall()>60))
	{
		ordercloseallwithprofit(4);		
	...
	if((OrdersTotal()==3)&&(orderprofitall()>40))
	{
		ordercloseallwithprofit(4);		
	...
	if((OrdersTotal() <= 2)&&(orderprofitall()>30))
	{
		ordercloseallwithprofit(4);		
