...
void initsymbol()
{
	...
	MySymbol[27] = "XAGUSD"; 	
	MySymbol[28] = "SPX500USD"; 	
	MySymbol[29] = "GBPCAD"; 	
	MySymbol[30] = "GBPNZD"; 	
	MySymbol[31] = "SUGARUSD"; 	
	MySymbol[32] = "USDSGD"; 	
	MySymbol[33] = "USDZAR"; 	
	MySymbol[34] = "EU50EUR"; 	
	MySymbol[35] = "EURSGD"; 
		...
		
   	{
		...
		if((-4 == BoolCrossRecord[SymPos][timeperiodnum].CrossFlagChange)
   		...
   		{	
			...
			Print(my_symbol+" MagicNumberThree2 OrderSend:" + "orderLots=" + orderLots +"orderPrice ="
						+orderPrice+"orderStopless="+orderStopless);	
			if(true == accountcheck())
			{					
				ticket = OrderSend(my_symbol,OP_BUY,orderLots,orderPrice,3,orderStopless,orderTakeProfit,
		...
		&&(OneMOrderCloseStatus(MakeMagic(SymPos,MagicNumberFour))==true))
   	{
		...
		if((4 == BoolCrossRecord[SymPos][timeperiodnum].CrossFlagChange)
		...
		
   		{
			...
			Print(my_symbol+" MagicNumberFour2 OrderSend" + "orderLots=" + orderLots +"orderPrice ="+	 
			orderPrice+"orderStopless="+orderStopless);		
			 if(true == accountcheck())
			 {
				 ticket = OrderSend(my_symbol,OP_SELL,orderLots,orderPrice,3,orderStopless,orderTakeProfit,
	...
	if(((BoolCrossRecord[SymPos][timeperiodnum+2].CrossStrongWeak[0]>0.8)
		...
		if((1==BoolCrossRecord[SymPos][timeperiodnum].BoolFlag)			
			...
			+ BoolCrossRecord[SymPos][timeperiodnum].CrossFlag[9]);
				...
				Print(my_symbol+" MagicNumberSeven2 OrderSend:" + "orderLots=" + orderLots +"orderPrice ="
						+orderPrice+"orderStopless="+orderStopless);	
									
			if(true == accountcheck())
			{
				ticket = OrderSend(my_symbol,OP_BUY,orderLots,orderPrice,3,orderStopless,orderTakeProfit,
							   my_symbol+"MagicNumberSeven2",MakeMagic(SymPos,MagicNumberSeven),0,Blue);
	
				 if(ticket <0)
				 {
					Print("OrderSend MagicNumberSeven2 failed with error #",GetLastError());
					if(GetLastError()!=134)
					{
						 //---- 5 seconds wait
						 Sleep(5000);
				 ...
				 {     
					...
					BuySellPosRecord[SymPos].TradeTimePos[6] = iBars(my_symbol,my_timeperiod);				 				 
					Print("OrderSend MagicNumberSeven2  successfully");
				 }													
				Sleep(1000);		
			}					
	...
	if(((BoolCrossRecord[SymPos][timeperiodnum+2].CrossStrongWeak[0]<0.2)
			...
			&&(OneMOrderCloseStatus(MakeMagic(SymPos,MagicNumberEight))==true))
   	{
		...
		if((4==BoolCrossRecord[SymPos][timeperiodnum].BoolFlag)			
			...
			Print(my_symbol+" MagicNumberEight2 OrderSend" + "orderLots=" + orderLots +"orderPrice ="
				+ orderPrice+"orderStopless="+orderStopless);							
			 if(true == accountcheck())
			 {
				 ticket = OrderSend(my_symbol,OP_SELL,orderLots,orderPrice,3,orderStopless,orderTakeProfit,
								   my_symbol+"MagicNumberEight2",MakeMagic(SymPos,MagicNumberEight),0,Blue);
		
				 if(ticket <0)
				 {
					Print("OrderSend MagicNumberEight2 failed with error #",GetLastError());
					if(GetLastError()!=134)
					{
						 //---- 5 seconds wait
						 Sleep(5000);
				 ...
				 {   
					...
					BuySellPosRecord[SymPos].TradeTimePos[7] = iBars(my_symbol,my_timeperiod);				 					 
					Print("OrderSend MagicNumberEight2  successfully");
				 }
...
void orderbuyselltypethree(int SymPos)
{
		...
		if((1==BoolCrossRecord[SymPos][timeperiodnum].BoolFlag)			
			...
			&&(-4 == BoolCrossRecord[SymPos][timeperiodnum-1].CrossFlagChange))			
   		{
			...
			+ BoolCrossRecord[SymPos][timeperiodnum].CrossFlag[9]);
				...
				Print(my_symbol+" MagicNumberEleven2 OrderSend:" + "orderLots=" + orderLots +"orderPrice ="
						+orderPrice+"orderStopless="+orderStopless);	
									
			if(true == accountcheck())
			{
				ticket = OrderSend(my_symbol,OP_BUY,orderLots,orderPrice,3,orderStopless,orderTakeProfit,
							   my_symbol+"MagicNumberEleven2",MakeMagic(SymPos,MagicNumberEleven),0,Blue);
	
				 if(ticket <0)
				 {
					Print("OrderSend MagicNumberEleven2 failed with error #",GetLastError());
					if(GetLastError()!=134)
					{
						 //---- 5 seconds wait
						 Sleep(5000);
				 ...
				 {    
					...
					BuySellPosRecord[SymPos].TradeTimePos[10] = iBars(my_symbol,my_timeperiod);				 				 
					Print("OrderSend MagicNumberEleven2  successfully");
				 }													
				Sleep(1000);		
			}					
	...
	if(((BoolCrossRecord[SymPos][timeperiodnum+2].CrossStrongWeak[0]<0.2)
		...
		if((-1==BoolCrossRecord[SymPos][timeperiodnum].BoolFlag)			
			...
			Print(my_symbol+" MagicNumberTwelve2 OrderSend" + "orderLots=" + orderLots +"orderPrice ="
				+	 orderPrice+"orderStopless="+orderStopless);							
			if(true == accountcheck())
			{
				 ticket = OrderSend(my_symbol,OP_SELL,orderLots,orderPrice,3,orderStopless,orderTakeProfit,
								   my_symbol+"MagicNumberTwelve2",MakeMagic(SymPos,MagicNumberTwelve),0,Blue);
		
				 if(ticket <0)
				 {
					Print("OrderSend MagicNumberTwelve2 failed with error #",GetLastError());
					if(GetLastError()!=134)
					{
						 //---- 5 seconds wait
						 Sleep(5000);
				 ...
				 {   
					...
					BuySellPosRecord[SymPos].TradeTimePos[11] = iBars(my_symbol,my_timeperiod);				 					 
					Print("OrderSend MagicNumberTwelve2  successfully");
				 }
			...
			if(NowMagicNumber == MagicNumberOne)
			{
				...
				if((0>BoolCrossRecord[SymPos][timeperiodnum+1].BoolFlag )
					...
					&&((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].NextModifyPos[0]) < -1000))
					{
						 ...
						 if(ticket <0)
						 {
							Print("OrderClose MagicNumberOne00 666 failed with error #",GetLastError());
						 }
						 else
						 {            
							Print("OrderClose MagicNumberOne00 666  successfully");
						 }    
						 Sleep(1000); 																								
					}						
			...
			if(NowMagicNumber == MagicNumberTwo)
			{
				...
				if((0 <BoolCrossRecord[SymPos][timeperiodnum+1].BoolFlag)
					...
					&&((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].NextModifyPos[1]) < -1000))					
					{
						 ...
						 if(ticket <0)
						 {
							Print("OrderClose MagicNumberTwo00 666 failed with error #",GetLastError());
						 }
						 else
						 {            
							Print("OrderClose MagicNumberTwo00 666  successfully");
						 }    
						 Sleep(1000); 																		
       ...
       {	
			...
			if(NowMagicNumber == MagicNumberSeven)
			{
					...
					&&(-4.5 > BoolCrossRecord[SymPos][timeperiodnum-1].BoolFlag))
				{
					 ...
					 if(ticket <0)
					 {
						Print("OrderClose MagicNumberSeven00 99999 failed with error #",GetLastError());
					 }
					 else
					 {            
						Print("OrderClose MagicNumberSeven00 99999  successfully");
					 }    
					 Sleep(1000); 																		
			...
			if(NowMagicNumber == MagicNumberEight)
			{
					...
					&&(4.5 < BoolCrossRecord[SymPos][timeperiodnum-1].BoolFlag))
				{
					 ...
					 if(ticket <0)
					 {
						Print("OrderClose MagicNumberEight00 99999 failed with error #",GetLastError());
					 }
					 else
					 {            
						Print("OrderClose MagicNumberEight00 99999  successfully");
					 }    
					 Sleep(1000); 																		
       ...
       {	
			...
			if(NowMagicNumber == MagicNumberEleven)
			{
					...
					&&(-4.5 > BoolCrossRecord[SymPos][timeperiodnum-1].BoolFlag))
				{
					 ...
					 if(ticket <0)
					 {
						Print("OrderClose MagicNumberEleven00 99999 failed with error #",GetLastError());
					 }
					 else
					 {            
						Print("OrderClose MagicNumberEleven00 99999  successfully");
					 }    
					 Sleep(1000); 																		
				}						
			...
			if(NowMagicNumber == MagicNumberTwelve)
			{
					...
					&&(4.5 < BoolCrossRecord[SymPos][timeperiodnum-1].BoolFlag))
				{
					 ...
					 if(ticket <0)
					 {
						Print("OrderClose MagicNumberTwelve00 99999 failed with error #",GetLastError());
					 }
					 else
					 {            
						Print("OrderClose MagicNumberTwelve00 99999  successfully");
					 }    
					 Sleep(1000); 																		
