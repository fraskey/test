...
void monitoraccountprofit()
{
	...
	//if(1 == Period())
	{
		...
		/*超过10个订单，且每个订单都盈利的情况下，直接关掉所有盈利订单*/
		
		if((ordercountall()>10)&&(ordercountall() == profitordercountall(0)))
		{
		...
		if(profitorderprofitall() > 10000*MyLotsH)
		{			
		...
		if(orderprofitall() > 5000*MyLotsH)
		{
		...
		/*十个以上40美金订单，直接关掉所有盈利订单，落袋为安，完成一次循环*/
		if(ordercountwithprofit(400*MyLotsH)>= 10)
		{
			
			ordercloseallwithprofit(200*MyLotsH);
			Print("4.0 This turn Own more than Ten "+500*MyLotsH+" USD,Close all");
		}


		/*7个以上50美金订单，直接关掉所有盈利订单，落袋为安，完成一次循环*/
		if(ordercountwithprofit(500*MyLotsH)>= 7)
		{
			
			ordercloseallwithprofit(400*MyLotsH);
			Print("4 This turn Own more than Seven "+500*MyLotsH+" USD,Close all");
		}

		/*四个以上70美金订单，直接关掉所有盈利订单，落袋为安，完成一次循环*/
		if(ordercountwithprofit(700*MyLotsH)>= 4)
		{
			
			ordercloseallwithprofit(600*MyLotsH);
			Print("5 This turn Own more than Four "+700*MyLotsH+" USD,Close all");
		}

		/*两个以上100美金订单，直接关掉所有盈利订单，落袋为安，完成一次循环*/
		if(ordercountwithprofit(1000*MyLotsH)>= 2)
		{		
			ordercloseallwithprofit(800*MyLotsH);
			Print("6 This turn Own more than two "+1000*MyLotsH+" USD,Close all");
		}
		
		/*一个以上150美金订单，直接关掉所有盈利订单，落袋为安，完成一次循环*/
		if(ordercountwithprofit(1500*MyLotsH)>= 1)
		{		
			ordercloseallwithprofit(1000*MyLotsH);
			Print("7 1、This turn Own more than one "+1000*MyLotsH+" USD,Close all");
		}


		/*订单数量20个，且获利超过480美元，落袋为安*/
		if((ordercountwithprofit(-100)==20)&&(orderprofitall()>4800*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("8 This turn Own more than one "+4800*MyLotsH+" USD,equal 13 order Close all");		
		}	

		/*订单数量19个，且获利超过460美元，落袋为安*/
		if((ordercountwithprofit(-100)==19)&&(orderprofitall()>4600*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("9 This turn Own more than one "+4600*MyLotsH+" USD,equal 13 order Close all");		
		}	

		/*订单数量18个，且获利超过440美元，落袋为安*/
		if((ordercountwithprofit(-100)==18)&&(orderprofitall()>4400*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("10 This turn Own more than one "+4400*MyLotsH+" USD,equal 12 order Close all");		
		}	

		
		/*订单数量17个，且获利超过420美元，落袋为安*/
		if((ordercountwithprofit(-100)==17)&&(orderprofitall()>4200*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("11 This turn Own more than one "+4200*MyLotsH+" USD,equal 13 order Close all");		
		}	

		/*订单数量16个，且获利超过400美元，落袋为安*/
		if((ordercountwithprofit(-100)==16)&&(orderprofitall()>4000*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("12 This turn Own more than one "+4000*MyLotsH+" USD,equal 12 order Close all");		
		}	
		
		/*订单数量15个，且获利超过380美元，落袋为安*/
		if((ordercountwithprofit(-100)==15)&&(orderprofitall()>3800*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("13 This turn Own more than one "+3800*MyLotsH+" USD,equal 11 order Close all");		
		}

		
		/*订单数量14个，且获利超过360美元，落袋为安*/
		if((ordercountwithprofit(-100) == 14)&&(orderprofitall()>3600*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("14 This turn Own more than one "+3600*MyLotsH+" USD,equal1 or 10 order Close all");		
		}	
		...
		if((ordercountwithprofit(-100)==13)&&(orderprofitall()>3400*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("15 This turn Own more than one "+3400*MyLotsH+" USD,equal 13 order Close all");		
		}	

		/*订单数量12个，且获利超过320美元，落袋为安*/
		if((ordercountwithprofit(-100)==12)&&(orderprofitall()>3200*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("16 This turn Own more than one "+3200*MyLotsH+" USD,equal 12 order Close all");		
		}	
		
		/*订单数量11个，且获利超过300美元，落袋为安*/
		if((ordercountwithprofit(-100)==11)&&(orderprofitall()>3000*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("17 This turn Own more than one "+3000*MyLotsH+" USD,equal 11 order Close all");		
		}

		
		/*订单数量10个，且获利超过280美元，落袋为安*/
		if((ordercountwithprofit(-100) == 10)&&(orderprofitall()>2800*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("18 This turn Own more than one "+2800*MyLotsH+" USD,equal1 or 10 order Close all");		
		}	
		...
		if((ordercountwithprofit(-100)==9)&&(orderprofitall()>2600*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("19 This turn Own more than one "+2600*MyLotsH+" USD,equal 9 order Close all");		
		}	

		/*订单数量8个，且获利超过240美元，落袋为安*/
		if((ordercountwithprofit(-100)==8)&&(orderprofitall()>2400*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("20 This turn Own more than one "+2400*MyLotsH+" USD,equal 8 order Close all");		
		}	
		
		/*订单数量7个，且获利超过220美元，落袋为安*/
		if((ordercountwithprofit(-100)==7)&&(orderprofitall()>2200*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("21 This turn Own more than one "+2200*MyLotsH+" USD,equal 7 order Close all");		
		}

		
		/*订单数量6个，且获利超过200美元，落袋为安*/
		if((ordercountwithprofit(-100) == 6)&&(orderprofitall()>2000*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("22 This turn Own more than one "+2000*MyLotsH+" USD,equal1 or 6 order Close all");		
		}	
		...
		if((ordercountwithprofit(-100)==5)&&(orderprofitall()>1800*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("23 This turn Own more than one "+1800*MyLotsH+" USD,equal 5 order Close all");		
		}	

		/*订单数量4个，且获利超过150美元，落袋为安*/
		if((ordercountwithprofit(-100)==4)&&(orderprofitall()>1500*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("24 This turn Own more than one "+1500*MyLotsH+" USD,equal 4 order Close all");		
		}	
		
		/*订单数量3个，且获利超过120美元，落袋为安*/
		if((ordercountwithprofit(-100)==3)&&(orderprofitall()>1200*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("25 This turn Own more than one "+1200*MyLotsH+" USD,equal 3 order Close all");		
		}
		
		/*订单数量1\2个，且获利超过80美元，落袋为安*/
		if((ordercountwithprofit(-100) <= 2)&&(orderprofitall()>800*MyLotsH))
		{
			ordercloseallwithprofit(-100);		
			Print("26 This turn Own more than one "+800*MyLotsH+" USD,equal1 or 2 order Close all");		
		}	
   ...
   {	
			...
			if ( BoolCrossRecord[SymPos][timeperiodnum].ChartEvent != iBars(my_symbol,my_timeperiod))
			{
				...
				if(NowMagicNumber == MagicNumberOne)
				{
					...
					if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[0])>720)
					{
						ticket =OrderClose(OrderTicket(),OrderLots(),vbid,5,Red);
					...
					else if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[0])>540)
					{  
				...
				if(NowMagicNumber == MagicNumberTwo)
				{
				   ...
				   else
				   {
					...
					/*一分钟1200个周期，理论上应该走完了,960周期开始监控时间控制*/
					if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[1])>720)
					{
						ticket =OrderClose(OrderTicket(),OrderLots(),vask,5,Red);
					...
					else if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[1])>540)
					{  
				...
				if(NowMagicNumber == MagicNumberThree)
				{
				   ...
				   else
				   {
					...
					/*一分钟1200个周期，理论上应该走完了,960周期开始监控时间控制*/
					if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[2])>720)
					{
						ticket =OrderClose(OrderTicket(),OrderLots(),vbid,5,Red);
					...
					else if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[2])>540)
					{  
				...
				if(NowMagicNumber == MagicNumberFour)
				{
				   ...
				   else
				   {
					...
					/*一分钟1200个周期，理论上应该走完了,960周期开始监控时间控制*/
					if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[3])>720)
					{
						ticket =OrderClose(OrderTicket(),OrderLots(),vask,5,Red);
					...
					else if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[3])>540)
					{  
				...
				if(NowMagicNumber == MagicNumberNine)
				{
					...
					/*一分钟1200个周期，理论上应该走完了,960周期开始监控时间控制*/
					if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[8])>720)
					{
						ticket =OrderClose(OrderTicket(),OrderLots(),vbid,5,Red);
					...
					else if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[8])>540)
					{  
				...
				if(NowMagicNumber == MagicNumberTen)
				{
				   ...
				   else
				   {
					...
					/*一分钟1200个周期，理论上应该走完了,960周期开始监控时间控制*/
					if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[9])>720)
					{
						ticket =OrderClose(OrderTicket(),OrderLots(),vask,5,Red);
					...
					else if((iBars(my_symbol,my_timeperiod)-BuySellPosRecord[SymPos].TradeTimePos[9])>540)
					{  
